    ...
    <el-table v-bind="$attrs" :stripe="true" style="width: 100%">
      <el-table-column type="expand">
        <template slot-scope="scope">
          <el-tag style="margin-right: 10px" v-for="(item, index) in scope.row.materialRecipe" :key="index" type="success"
            effect="plain" sizi="mideum">{{ getMaterialNameType(item.stockId)[0] }}/{{
      ...
      <el-table-column prop="price" label="单个成本" width="160" :sortable="true">
        <template slot-scope="scope">
      ...
      <el-table-column prop="last_updata" label="最近变动" width="250" :sortable="true">
        <template slot-scope="scope">
