<template>
  <div>
    <el-table v-bind="$attrs" :stripe="true" style="width: 100%" height="600">
      <el-table-column type="expand">
        <template slot-scope="scope">
          <el-tag style="margin-right: 10px" v-for="(item, index) in JSON.parse(scope.row.materialRecipe)" :key="index"
            type="success" effect="plain" sizi="mideum">{{ getMaterialNameType(item.stockId)[0] }}/{{
      ...
      <el-table-column prop="amount" label="数量" width="80" :sortable="true"></el-table-column>
      <el-table-column prop="price" label="单个成本" width="120" :sortable="true"></el-table-column>
      <el-table-column prop="total_cost" label="总成本" width="120" :sortable="true"></el-table-column>
      <el-table-column prop="updata_date" label="日期" width="250" :sortable="true">
        <template slot-scope="scope">
    ...
    <EditDialogForm @close="closeDialogFrom" :visible="dialogFromVisible" :editData="editData" />
  </div>
</template>
